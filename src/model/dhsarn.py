...
## Dense-connected Hierarchical Multi-Scale Self-Attention Residual Network (DHSARN)
class DHSARN(nn.Module):
    def __init__(self, args, conv=common.default_conv):
        super(DHSARN, self).__init__()
