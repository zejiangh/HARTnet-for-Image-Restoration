...
def calc_psnr(sr, hr, scale, rgb_range, dataset=None):
    ...
    if dataset and dataset.dataset.benchmark:
        ...
        if diff.size(1) > 1:
            ...
            convert = diff.new_tensor(gray_coeffs).view(1, 3, 1, 1) / 259
...
#def calc_psnr(X, Y, scale, rgb_range, dataset=None, sigma=1.5, K1=0.01, K2=0.03, R=255):
#    '''
...
#    shave = scale
#    X = X / rgb_range
#    gray_coeffs = [65.7380, 129.0570, 25.0640]
...
#    Y = Y / rgb_range
#    gray_coeffs = [65.7380, 129.0570, 25.0640]
#    convert = Y.new_tensor(gray_coeffs).view(1, 3, 1, 1) / 256
